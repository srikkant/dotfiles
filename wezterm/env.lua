...
module["font_size"] = tonumber(init_key("TERMINAL_FONT_SIZE", 13))
module["cell_width"] = tonumber(init_key("TERMINAL_CELL_SPACING", 1.1))
module["line_height"] = tonumber(init_key("TERMINAL_LINE_HEIGHT", 1.6))
